\chapter{Evaluating PX in Playtherapy PREG}
...
& Characterise Playtherapy's mini \acp{PREG}
& Characteristics
...
%----------------------
\toprule
\spacedlowsmallcaps{Type of patient}
&\spacedlowsmallcaps{Age range}
&\spacedlowsmallcaps{Academic level}
&\spacedlowsmallcaps{Gender representation}\\\midrule
Children & 5 - 12 & Primary school  & Proportional\\\midrule
Teenagers & 13 - 17 & Secondary school & Mainly male\\\midrule
Young adults & 18 - 35  & Secondary school & Mainly male\\\midrule
Adults & 36 - 60 & Primary school & Mainly female\\\midrule
Elderly adults & +60 & Primary school & Mainly female\\
\bottomrule
\end{tabular}}
\label{tab:demographic_chars_patients}
\end{table}

Regarding patients' disposition during therapy, the physiotherapists commented that children and teenagers are willing to work during the therapy sessions and understand what they should do easily. Young adults and adults do not like reading and prefer visual aids. Finally, physiotherapists should monitor elderly patients closely since they have comprehension difficulties and get easily confused with the instructions.
...
\subfloat[Elderly adult patient]{
...
Playtherapy is developed in an academic environment. The defined sprint length for the project is two weeks. As expected, a planning, a review and a retrospective meeting are performed every sprint. The development team is composed as follows:
\begin{itemize}
...
Health instruments & Goniometer\\
\bottomrule
\end{tabular}}
\label{tab:beisbol_char}
\end{table}

Furthermore, Playtherapy has an accompanying web application composed of three main modules. The first module is concerned with patients and physiotherapists demographic data. The second module allows physiotherapists managing patients \ac{FIM}. Finally, the third module allows visualising mini \ac{PREG} sessions data; e.g., registered observations, progress over time and performance measurements, like the maximum range degree achieved per session. By the time this master project took place, this application was still under development and was not connected to Playtherapy; thus, it was not evaluated.
...
& \acp{PREG}'s functional characteristics, patients' processes and responses \\
\bottomrule
\end{tabular}}
...
Viajando en el Espacio \autocite{Lopez2017b} &  &  \\
\bottomrule
\end{tabular}}
\label{tab:participnats_interaction_eval}
\end{table}

Additional information regarding \textit{health status} and \textit{gaming activity} was obtained for eight of the patients who participated in the evaluation (See \autoref{tab:participnats_demographic}). 

\begin{table}[bth]
\caption{Demographic information of 8 participants of the \ac{PX} evaluation sessions}
\myfloatalign
\resizebox{\linewidth}{!}{
\begin{tabular}{ccclp{5cm}p{2cm}p{2.5cm}}
\toprule
\spacedlowsmallcaps{Patient}
&\spacedlowsmallcaps{Age}
&\spacedlowsmallcaps{Gender}
& \spacedlowsmallcaps{Affected joint} 
& \spacedlowsmallcaps{Preferred platform(s)}
& \spacedlowsmallcaps{Years playing} 
& \spacedlowsmallcaps{Gameplay frequency}\\\midrule
1 & 23 & F & Knee & Arcade machines & < 5 & Daily\\\midrule
2 & 26 & M & Lower-upper limbs & PlayStation & 6 - 10 & Daily\\\midrule
3 & 26 & M & Knee and foot & PlayStation, XBox, Arcade machines & 6 - 10 & Weekly\\\midrule 
4 & 30 & M & Shoulder & PlayStation & > 10 & Weekly\\\midrule
5 & 26 & F & Spine & - & - & - \\\midrule
6 & 40 & F & Knee and hip & - & - & - \\\midrule
7 & 49 & M & Knee & - & - & - \\\midrule
8 & 47 & F & Shoulder & - & - & - \\
\bottomrule
\end{tabular}}
...
\begin{table}[tbh]
\caption{Configuration that physiotherapists use to test the configuration capability of each mini \ac{PREG}}
\myfloatalign
\resizebox{\linewidth}{!}{
...
\toprule
\multirow{2}{*}{\spacedlowsmallcaps{Score}} & \multicolumn{6}{c}{\spacedlowsmallcaps{Percentage of mini PREGs that reached the score}} \\\cline{2-7}
& Satisfaction
& Learnability
& Effectiveness
& Immersion
& Motivation
& Emotion \\\midrule
Excellent & \textbf{78,57\%} & 28,57\% & 14,29\% & \textbf{92,86\%} & 35,71\% & \textbf{85,71\%} \\
Acceptable & 21,43\% & \textbf{64,29\%} & \textbf{78,57\%} & 7,14\% & \textbf{50,00\%} & 14,29\% \\
Medium & 0,00\% & 7,14\% & 7,14\% & 0,00\% & 14,29\% & 0,00\% \\
